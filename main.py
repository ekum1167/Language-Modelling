...
if __name__ == "__main__":
    ...
    print("WordCloud with TFIDF worked!")
    project02.create_WordCloud(Docs,8,wordcloud_outputfile,mode="TF",stopwords=True)
    print("WordCloud with TF worked!")
    
    
    zips_outputfile = "outputs/project2_zips.png"
    project02.create_ZiphsPlot(Docs[0:100],zips_outputfile)
    print("Ziph's Law function worked!")

    heaps_outputfile = "outputs/project2_heaps.png"
    project02.create_HeapsPlot(Docs[0:100],heaps_outputfile)
    ...
    WE = project02.create_WordVectors(Docs,300,'Skipgram',5)
